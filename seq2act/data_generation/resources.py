...
# for input prompts
_candidate_words = "Lorem ipsum dolor sit amet consectetur adipiscing elit phasellus dignissim id potenti turpis morbi ac mus orci sem bibendum tempus".split(
    " ")
lock = threading.Lock()
